...
Finish with [The simulator has booked a second date: the interactive quiz](#date-audit-quiz). Six new cases include a transition matrix, sampling diagram, seeded counts and meeting branches. Apply the week's model and observation rules, then submit all six responses to unlock the score and worked explanations. The quiz is practice and carries no course marks.
...
4. **20 minutes — observation review and quiz.** Use ten minutes to review your prepared records: three checking the confirmed handover and separate arrival, four checking the “Who pays?” trace through its actual costs, and three comparing observation labels and your memoryless counterexample. Include leaving with an unresolved bill and withdrawing a previous next-date agreement. Explain why eye contact cannot be a consent flag and why bill acknowledgement is not payment or an obligation to meet again. Use the final ten minutes for the [six-case quiz](#date-audit-quiz): about eight minutes to respond and two to review the explanations after all cases are answered.
