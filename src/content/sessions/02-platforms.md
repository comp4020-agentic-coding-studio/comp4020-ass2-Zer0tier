...
Bring the **System boundary map**. Read the three primary platform descriptions linked in [week 2](/lectures/week-02/) and open the synthetic census.

## 90-minute tutorial

1. **20 minutes — draw the pipeline.** Mark retrieval, filters, ordering, exposure and mutual selection. Put proprietary weights in the unknown column.
...
Save a source/claim/unknown table, tested updater and census calculation log. Keep the initial boundary map and annotate changes rather than replacing its uncertainty with confidence.
