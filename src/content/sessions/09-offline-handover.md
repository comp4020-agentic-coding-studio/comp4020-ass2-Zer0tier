...
Finish with [The itinerary mistakes itself for an agreement: the interactive quiz](#handover-audit-quiz). Six new cases include venue cards, a contingency diagram and confirmation branches. Apply the week's constraints, probability and agreement rules, then submit all six responses to unlock the score and worked explanations. The quiz is practice and carries no course marks.
...
4. **20 minutes — dependence review and quiz.** Use ten minutes to review your prepared dependence calculation: four checking the conditional probabilities, three checking marginals and means, and three checking the changed tail and your mutation/restoration evidence. Set closure given lateness to 0.4 and closure given on-time to 0. Keep marginal closure at 0.1; show that the late-and-closed tail rises to 10% although both means stay unchanged. Retain the restored passing result. Use the final ten minutes for the [six-case quiz](#handover-audit-quiz): about eight minutes to respond and two to review the explanations after all cases are answered.
