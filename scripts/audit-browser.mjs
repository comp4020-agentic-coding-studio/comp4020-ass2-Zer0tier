...
try {
  for (const viewport of [{width:1920,height:1080},{width:390,height:844}]) {
    ...
    for (const route of routes) {
      ...
      if (['','weeks/','readings/','help/','faq/','lectures/week-02/','lectures/week-03/','lectures/week-04/','lectures/week-07/','lectures/week-10/','sessions/03-photo-assets/','sessions/04-bio-experiment/','sessions/12-maintenance/','assessments/profile-deployment/','toolkit/','policies/','decks/week-01/','decks/week-02/','decks/week-03/','decks/week-04/'].includes(route)) {
